    ...
    public class PISDatabase
     {
            ...
            using (MySqlConnection SqlConnection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, SqlConnection))
                {
                        ...
                        while (dataReader.Read())
                        {
                            ...
                            Remittance excess = new Remittance("0", userid, pagibig_loan_payment, pagibig_loan_paid, pagibig_loan_amount);
        ...
        public List<RegularModel> GetRegularEmployee(string SearchString)
        {
            ...
            string query = "SELECT tax.tax,cfi.max as cfi_payment,cfi.count as cfi_paid,cfi.amount as cfi_amount," +
                            ...
                            "pagibig_calamity.max as pagibig_calamity_payment,pagibig_calamity.count as pagibig_calamity_paid,pagibig_calamity.amount as pagibig_calamity_amount," +
                            ...
                            "LEFT JOIN payroll.pagibig_calamity_remittance pagibig_calamity ON pagibig_calamity.userid = p.userid " +
            ...
            using (MySqlConnection SqlConnection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, SqlConnection))
                {
                    ...
                    while (dataReader.Read())
                    {
                        ...
                        string pagibig_calamity_amount = (!dataReader.IsDBNull(dataReader.GetOrdinal("pagibig_calamity_amount"))) ? dataReader["pagibig_calamity_amount"].ToString() : "0.00";
                        string pagibig_calamity_payment = (!dataReader.IsDBNull(dataReader.GetOrdinal("pagibig_calamity_payment"))) ? dataReader["pagibig_calamity_payment"].ToString() : "0";
                        string pagibig_calamity_paid = (!dataReader.IsDBNull(dataReader.GetOrdinal("pagibig_calamity_paid"))) ? dataReader["pagibig_calamity_paid"].ToString() : "0";
                        Remittance pagibig_calamity = new Remittance("0", userid, pagibig_calamity_payment, pagibig_calamity_paid, pagibig_calamity_amount);
                        ...
                        regularModel.SetPagibigCalamity(pagibig_calamity);
