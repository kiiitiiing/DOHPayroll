...
namespace PayrollSystem.Models
{
    public class SalaryChargePDFView
    {
        ...
        public static PdfPTable RegularSalaryChargeItem(int count, string id, string name, string position, RegularPayslipModel model)
        {
            ...
            data.AddCell(new PdfPCell(new Phrase("PRM", new Font(FontFactory.GetFont("HELVETICA", 8, Font.NORMAL, new BaseColor(0, 0, 0)))))
            {
                Padding = 2,
                Border = PdfPCell.LEFT_BORDER,
            ...
            /*data.AddCell(new PdfPCell(new Phrase("CAL", new Font(FontFactory.GetFont("HELVETICA", font_size, Font.NORMAL, new BaseColor(0, 0, 0)))))
            {
                Padding = 2,
                Border = PdfPCell.LEFT_BORDER,
                HorizontalAlignment = Element.ALIGN_CENTER,
            ...
            font_size = (model.FirstHalf.PagibigCalamity.ToString("#,##0.00").Length >= 9) ? 6 : 8;
            data.AddCell(new PdfPCell(new Phrase(model.FirstHalf.PagibigMp2.ToString("#,##0.00"), new Font(FontFactory.GetFont("HELVETICA", font_size, Font.NORMAL, new BaseColor(0, 0, 0)))))
            {
                Padding = 2,
                Border = PdfPCell.LEFT_BORDER,
            ...
            font_size = (model.FirstHalf.PagibigCalamity.ToString("#,##0.00").Length >= 9) ? 6 : 8;
            data.AddCell(new PdfPCell(new Phrase(model.FirstHalf.PagibigCalamity.ToString("#,##0.00"), new Font(FontFactory.GetFont("HELVETICA", font_size, Font.NORMAL, new BaseColor(0, 0, 0)))))
            {
                Padding = 2,
                Border = PdfPCell.LEFT_BORDER,
                HorizontalAlignment = Element.ALIGN_RIGHT,
            ...
            data.AddCell(new PdfPCell(new Phrase("35", new Font(FontFactory.GetFont("HELVETICA", rate_size, Font.NORMAL, new BaseColor(255, 255, 255)))))
            {
        ...
        public static PdfPTable RegularSalaryChargeHeader(int count, string month, int year, string salary_charge)
        {
            ...
            header.AddCell(new PdfPCell(new Phrase("BASIC SALARY/PERA", new Font(FontFactory.GetFont("HELVETICA", 7, Font.BOLD, new BaseColor(0, 0, 0)))))
            {
                PaddingTop = 15,
                Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.BOTTOM_BORDER,
                Rowspan = 2,
            ...
            header.AddCell(new PdfPCell(new Phrase("GROSS\nINCOME\nO.A.INC./PERA", new Font(FontFactory.GetFont("HELVETICA", 7, Font.BOLD, new BaseColor(0, 0, 0)))))
            {
                Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.BOTTOM_BORDER,
                HorizontalAlignment = Element.ALIGN_CENTER,
                VerticalAlignment = Element.ALIGN_CENTER
            });
            header.AddCell(new PdfPCell(new Phrase("WTAX/\nPHIC", new Font(FontFactory.GetFont("HELVETICA", 7, Font.BOLD, new BaseColor(0, 0, 0)))))
            {
                PaddingTop = 8,
                Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.BOTTOM_BORDER,
                HorizontalAlignment = Element.ALIGN_CENTER,
