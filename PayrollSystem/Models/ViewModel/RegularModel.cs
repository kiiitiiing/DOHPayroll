...
namespace PayrollSystem.Models
{
    public class RegularModel : Employee
    {
        ...
        public Remittance pagibigCalamity { get; set; }
        ...
        public Remittance GetPagibigCalamity()
        {
            return pagibigCalamity;
        }

        public void SetPagibigCalamity(Remittance pagibigCalamity)
        {
        ...
        public string PagibigCalamityFormat()
        {
            return pagibigCalamity.Amount + "/" + pagibigCalamity.MaxCount + "/" + pagibigCalamity.Count;
        }
